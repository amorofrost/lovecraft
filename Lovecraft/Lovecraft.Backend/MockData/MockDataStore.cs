...
public static class MockDataStore
{
    ...
    {
        new() { Id = "1", Title = "Звездное небо", Album = "Первый альбом", Duration = "3:45", PreviewUrl = "", Year = 2018 },
        new() { Id = "2", Title = "Летний ветер", Album = "Первый альбом", Duration = "4:12", PreviewUrl = "", Year = 2018 },
        new() { Id = "3", Title = "Новые горизонты", Album = "Второй альбом", Duration = "3:28", PreviewUrl = "", Year = 2020 },
    };
    ...
    {
        new() { Id = "general", Name = "Общий", Description = "Общие обсуждения", TopicCount = 12 },
        new() { Id = "music", Name = "Музыка", Description = "Обсуждение песен и альбомов", TopicCount = 8 },
        new() { Id = "cities", Name = "Города", Description = "Региональные темы", TopicCount = 5 },
        new() { Id = "offtopic", Name = "Офтопик", Description = "Все остальное", TopicCount = 15 },
    };
